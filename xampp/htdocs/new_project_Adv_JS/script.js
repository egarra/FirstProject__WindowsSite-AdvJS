...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var calcButton = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, true); //showModalByTime('.popup', 60000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    content[i].classList.add('newFadeIn');
  }
